	                                            ...
	                                            <div class="user-avatar-info">
	                                                <div class="m-b-20">
                                                       <div>
                                                            ...
                                                            <input type="text"  class="form-control form-control-lg" value="<?php if($_SERVER['HTTP_HOST'] == "localhost") {echo $_SERVER['HTTP_HOST']."/ez-drive/preview.php?file=".$_GET['nama_files'];}else{ echo $_SERVER['HTTP_HOST']."/preview.php?file=".$_GET['nama_files'];}?>" id="link" disabled>
