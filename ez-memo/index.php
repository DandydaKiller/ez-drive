...
<?php
		if(isset($_GET['pesan'])){
			if($_GET['pesan'] == "loginsalah"){
				echo "password atau email salah";
			}else if($_GET['pesan'] == "tidakdaftar"){
				echo "email belum terdaftar sebagai user";
			}
		?>
</p>
<?php  if($_GET['pesan'] == "berhasilregister"){?>
	<p style="color:green">
	<?php echo "Registrasi berhasil"?>
	</p>
<?php }

}?>
      <form id="login" action="Controller/login-controller.php" method="post"> 
        ...
        <input type="submit" class="wed" name="" value="Login"> 
