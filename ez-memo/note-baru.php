    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">Note Baru</h3>
            ...
            <div class="container-fluid">
                ...
                ?></p>
                                <form action="Controller/note-baru-controller.php" method="post" class="form-horizontal form-material">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <textarea rows="10"id="field" onkeyup="countChar(this)" name="isi" placeholder="ex: 1. Cara pertama yang harus dilakukan..." class="form-control pl-0 form-control-line"></textarea>
                                            <table>
                                                <tr>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12 d-flex">
                                            <button class="btn btn-success mx-auto mx-md-0 text-white"><i class="fas fa-plus"></i>Tambahkan Note</button>
